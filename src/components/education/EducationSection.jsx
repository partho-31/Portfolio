const EducationSection = ({ educationRef }) => {
  ...
  return (
    ...
    <section
      data-aos="fade-right"
      ref={educationRef}
      className="scroll-mt-24 mx-4 sm:mx-6 md:mx-10 lg:mx-16  sm:my-56 p-6 sm:p-8 md:p-10 rounded-2xl border-2 border-white/25 bg-transparent backdrop-blur-3xl"
    >
      <div>
